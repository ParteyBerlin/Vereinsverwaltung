...
$statement = $pdo->prepare("SELECT * FROM verein WHERE verein_id = ?"); #in prepare darf man noch keine expliziten Werte angeben, deswegen = ?
$statement->execute(array($id)); #erstelle Array mit o.g. ID
$vereine = $statement->fetchAll(PDO::FETCH_ASSOC); #fetchAll liest alle[*] Datensätze der DB aus
//print_r($vereine);
